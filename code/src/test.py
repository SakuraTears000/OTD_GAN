...
from lib.modules import sample as sample_test
...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./sampled_image',
                        help='sampled image save director')
    ...
    parser.add_argument('--local-rank', default=-1, type=int,
                        help='node rank for distributed tplraining')
...
def main(args): 
    ...
    sample_test(valid_dl, netG, text_encoder, save_dir, args.device, args.multi_gpus, args.z_dim, args.sample_times)
    # if (args.multi_gpus==True) and (get_rank() != 0):
    #     None
    # else:
